...
@section('content')
    ...
    <form method="post" action="/assets/{{ $asset->id }}">
        ...
        <div class="form-group">
            ...
            <input name="name" type="text" value="{{ $asset->name}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input name="amount" type="text" value="{{ $asset->amount }}">
        </div>
        <div class="form-group">
            <label for="purchase-date">Purchase Date</label>
            <input name="purchase_date" type="text" class="hasdatepicker" value="{{ $asset->purchase_date }}">
        </div>
        <div class="form-group">
            <label for="service-start-date">Service Start Date</label>
            <input name="service_start_date" type="text" class="hasdatepicker" value="{{ $asset->service_start_date }}">
        </div>
        <div class="form-group">
            <label for="expiration-date">Expiration Date</label>
            <input name="expiration_date" type="text" class="hasdatepicker" value="{{ $asset->expiration_date }}" readonly>
        </div>
